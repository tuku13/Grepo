...
import guis.ResourcePanel;

public enum BuildingType {
    SENATE(15,3,1.78,new ResourceStack(5,2,2),1.5,"Szenátus","images/senate.png"),
    TIMBER_CAMP(20,2,1.54,new ResourceStack(3,2,1),1.47,"Fatelep","images/timber_camp.png"),
    QUARRY(20,2,1.54,new ResourceStack(1,3,2),1.47,"Kőfejtő","images/quarry.png"),
    SILVER_MINE(20,2,1.54,new ResourceStack(1,3,2),1.47,"Ezüstbánya","images/silver_mine.png"),
    BARRACKS(8,10,2.3,new ResourceStack(70,20,40),1.6,"Kaszárnya","images/barracks.png"),
    TEMPLE(10,14,1.8,new ResourceStack(25,45,30),1.58,"Templom","images/temple.png"),
    HARBOR(5,15,3.2,new ResourceStack(400,200,100),1.46,"Kikötő","images/harbor.png");
